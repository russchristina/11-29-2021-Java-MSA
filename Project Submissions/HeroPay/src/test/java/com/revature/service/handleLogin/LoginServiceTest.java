...
//
//        databaseMockLoginInfo = new LoginInfoEntity(1, mockUsernameInput, mockPasswordInput, new EmployeeAccountEntity());
//
//
//
//        MockitoAnnotations.openMocks(this);
//        try {
//            Mockito.when(loginInfoDao.getLoginInfo(mockUsernameInput, mockPasswordInput)).thenReturn(new LoginInfoEntity(1, mockUsernameInput, mockPasswordInput, new EmployeeAccountEntity()));
