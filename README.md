...
> This document provides a list of the required technologies for anyone who is training on the Java MSA track. It details why each technology is required and provides some step-by-step instructions on how to install and configure the technologies. This guide also walks you through any needed environment setup.
...
- **Node.js**: Node.js is a JavaScript runtime environment which executes JavaScript outside of your web browser. It also comes with its own package manager. We will use Node.js and its package manager while working with Angular.
