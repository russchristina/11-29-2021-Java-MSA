...
//			FileOutputStream fos = new FileOutputStream(myFile);
			...
			/*
			 * As far as FileIO goes, you have to handle FileNotFoundExceptions as they
		...
		try(FileReader reader = new FileReader(myFile); BufferedReader buffReader = new BufferedReader(reader)) {
